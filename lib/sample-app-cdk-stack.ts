...
export class SampleAppCdkStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    new CfnOutput(this, "InsecureBucketName", {
      ...
      description:
        "Name of the intentionally insecure S3 bucket for security testing",
    });

    new CfnOutput(this, "InsecureBucketArn", {
      value: insecureBucket.bucketArn,
      description:
        "ARN of the intentionally insecure S3 bucket for security testing",
    });
  }
}
